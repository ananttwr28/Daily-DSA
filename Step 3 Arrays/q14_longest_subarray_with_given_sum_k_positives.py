'''
Longest Subarray with given Sum K(Positives) 23/5/25
...
def find_max_subarray_length(nums, k):
    ...
    for i in range(0, n):  
        ...
        if prefix_sum-k in prefix_sum_dict:
            start_idx = prefix_sum_dict[prefix_sum-k]       # start idx of the subarr of sum=k will be the value of p_s-k
            max_subarray_length = max(max_subarray_length, i-start_idx)
